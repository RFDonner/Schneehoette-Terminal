    ...
    public static class TerminalState
    {
        ...
        public static void InitPrisoners()
        {
            ...
            List<Prisoner> playerPrisoners = new List<Prisoner>
            {
                ...
                {new Prisoner(Guid.Parse("a7b2ef5a-e639-4e09-a3f8-b3dcdbffb373"), "Clara Normal", SentenceState.Allgemein) },
                ...
                {new Prisoner(Guid.Parse("18be6270-f892-4103-a73f-b26470139c52"), "Jack Schaeffer", SentenceState.Politisch) },
                {new Prisoner(Guid.Parse("5d97c470-c696-46ca-8dfe-7fcb678e28e6"), "Otto Vulture Normal", SentenceState.Korruption) },
